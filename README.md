During the execution of the project I mainly focused on learning the backend, that is, programming the user's communication with the server and dynamic data updates. 
